...
export class MgtSearchResults extends MgtTemplatedTaskComponent {
    ...
    constructor() {
        ...
        this.renderContent = () => {
            ...
            else if ((_e = (_d = (_c = this.response) === null || _c === void 0 ? void 0 : _c.value[0]) === null || _d === void 0 ? void 0 : _d.hitsContainers[0]) === null || _e === void 0 ? void 0 : _e.hits) {
                renderedTemplate = html `${(_j = (_h = (_g = (_f = this.response) === null || _f === void 0 ? void 0 : _f.value[0]) === null || _g === void 0 ? void 0 : _g.hitsContainers[0]) === null || _h === void 0 ? void 0 : _h.hits) === null || _j === void 0 ? void 0 : _j.map(result => this.renderResult(result))}`;
            }
