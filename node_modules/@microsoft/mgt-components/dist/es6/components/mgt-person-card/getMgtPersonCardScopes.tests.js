...
describe('getMgtPersonCardScopes() tests', () => {
    ...
    const originalConfigOrgSection = Object.assign({}, MgtPersonCardConfig.sections.organization);
    const originalConfigSections = Object.assign({}, MgtPersonCardConfig.sections);
    beforeEach(() => {
        MgtPersonCardConfig.sections = Object.assign({}, originalConfigSections);
        MgtPersonCardConfig.sections.organization = Object.assign({}, originalConfigOrgSection);
...
//# sourceMappingURL=getMgtPersonCardScopes.tests.js.map