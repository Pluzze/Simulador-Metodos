...
import { MgtBaseComponent, mgtHtml } from '@microsoft/mgt-element';
...
const conflictBehaviors = ['rename', 'replace'];
...
const calculateConflictBehavior = (behavior) => {
    if ((behavior === null || behavior === void 0 ? void 0 : behavior.length) > 1) {
