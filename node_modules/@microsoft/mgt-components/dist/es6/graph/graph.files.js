 ...
 * @returns
 */
export const getDriveItemByQuery = (graph, resource, storeName = schemas.files.stores.fileQueries, scopes = validDriveItemScopes) => __awaiter(void 0, void 0, void 0, function* () {
    // get from cache
...
const getIterator = (graph, endpoint, storeName, top) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const fileList = yield getFileListFromCache(cache, storeName, cacheKey);
    if (fileList) {
...
export const getMyInsightsFiles = (graph, insightType) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield getDriveItemsByInsights(graph, insightResponse, validInsightScopes);
    if (getIsFileListsCacheEnabled()) {
...
export const getGraphfile = (graph, resource) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const response = (yield graph.api(resource).middlewareOptions(prepScopes(validDriveItemScopes)).get());
        return response || null;
        // eslint-disable-next-line no-empty
    }
    catch (_e) { }
...
export const deleteSessionFile = (graph, resource) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield graph.client.api(resource).middlewareOptions(prepScopes(validFileUploadScopes)).delete();
    }
    catch (_j) {
