 ...
 * @memberof Graph
 */
export const getUserWithPhoto = (_graph, _userId, _requestedProps) => __awaiter(void 0, void 0, void 0, function* () {
    return Promise.resolve({
        '@odata.context': 'https://graph.microsoft.com/v1.0/$metadata#users(businessPhones,displayName,givenName,jobTitle,department,mail,mobilePhone,officeLocation,preferredLanguage,surname,userPrincipalName,id,userType)/$entity',
